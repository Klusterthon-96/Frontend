        ...
        <>
            ...
            <div className="mt-4 font-sans">
                ...
                <ul className=" list-disc mb-3 w-fit p-3">
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Average Temperature Level 25&deg;C to 35&deg;C</li>
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Average Humidity: 70% to 80%</li>
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Optimal Soil pH: 5.5 to 6.5</li>
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Water Availability: Adequate</li>
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Season: Rainy season</li>
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Optimal Planting Time: March to May</li>
                    <li style={{ marginTop: "2px", marginLeft: "20px" }}>Optimal Harvesting Time: September to November</li>
                </ul>
