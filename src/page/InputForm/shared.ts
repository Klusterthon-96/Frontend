...
export const temperatureType = [
    { value: "cool", label: "Cool (15-18.99)" },
    { value: "mild", label: "Mild (19-23.99)" },
    { value: "warm", label: "Warm (24-28.99)" },
    { value: "hot", label: "Hot (29 and above)" }
];

export const humidityType = [
    { value: "low", label: "Low (0-19.99)" },
    { value: "moderate", label: "Moderate (20-39.99)" },
    { value: "average", label: "Average (40-59.99)" },
    { value: "high", label: "High (60-79.99)" },
    { value: "very high", label: "Very High (80 and above)" }
];
...
export const waterType = [
    { value: "low", label: "Low (0-49.99)" },
    { value: "moderate", label: "Moderate (50-99.99)" },
    { value: "high", label: "High (100 and above)" }
];
