        ...
        <div className=" text-center">
          ...
          <div className="flex justify-center items-center">
            <button
              ...
              className={isButtonDisabled ? "px-3 py-2 flex items-center text-white bg-[#006400] bg-opacity-50 cursor-not-allowed rounded-[32px]" : "px-3 py-2 flex items-center text-white bg-[#006400] rounded-[32px]"}
