                ...
                <header className="bg-white p-5 w-ull shadow-md">
                    <div className="flex items-center justify-end">
                        <div className="flex mr-auto">
                            <button onClick={() => setShow(!show)} className=" lg:hidden font-bold text-2xl">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M4 19L20 19" stroke="#141B34" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </button>
                        </div>
